function rSSFP = real_ssfp_signal(M_0i,M_0r,RF_dur,T_1,T_2,T_E,T_R,a,b_0,phi_incr)
%REAL_SSFP_SIGNAL
%    Compute the real component of the bSSFP signal - bSSFP = (M_0r + iM_0i) x (M_x + iM_y)
%    USAGE:
%        RSSFP = REAL_SSFP_SIGNAL(M_0I,M_0R,RF_DUR,T_1,T_2,T_E,T_R,A,B_0,PHI_INCR)
%
...
t28 = t25-t12.*t26.*t27;
t29 = 1.0./t28;
rSSFP = -M_0i.*t19.*t20.*t21.*t22.*t29-M_0r.*t12.*t20.*t21.*t22.*t29.*sin(t16);
